...
//     if (cachedTipos != null) {
//       setState(() {
//         tipos = List<Map<String, dynamic>>.from(json.decode(cachedTipos));
//       });
//     } else {
//       final response =
...
//     return Scaffold(
//       appBar: AppBar(title: const Text('Registrar Extintor')),
//       body: _isLoading
...
//                 children: [
//                   _buildTextField(
//                       controller: _patrimonioController, label: 'Patrimônio'),
...
//                   const SizedBox(height: 12),
//                   _buildTextField(
//                       controller: _capacidadeController, label: 'Capacidade'),
//                   const SizedBox(height: 12),
//                   _buildDropdown(
//                     label: 'Linha',
//                     items: linhas,
...
//                         _localizacaoSelecionada = null; // Reset localizacao
//                       });
...
//                   const SizedBox(height: 12),
//                   _buildTextField(
//                       controller: _observacoesController, label: 'Observações'),
...
//                     ElevatedButton(
//                       onPressed: () async {
//                         await Share.share('Confira este QR Code: $_qrCodeUrl');
//                       },
